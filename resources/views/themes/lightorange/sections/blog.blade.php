            ...
            <div class="row d-flex justify-content-md-center">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    <div class="single-item">
                        @if($k%2 !== 0)
                            <div class="img-area">
                                <img src="{{getFile(config('location.content.path').'thumb_'.@$data->content->contentMedia->description->image)}}" alt="@lang('blog-image')" style="">
                            </div>
                        @endif
                        <div class="text-area">
                            ...
                            <a href="{{route('blogDetails',[slug(@$data->description->title), $data->content_id])}}">
                                <p class="color-two">{{Illuminate\Support\Str::limit(strip_tags(@$data->description->description),120)}}</p>
                            </a>
